...
#define FW_USERCONFIG_NAME_8800DC_MA14H   "aic_userconfig_8800dc_ma14h.txt"
...
int	rwnx_plat_userconfig_load_8800dc(struct rwnx_hw *rwnx_hw){
    ...
    if (rwnx_hw->usbdev->vid == USB_VENDOR_ID_MERCUSYS &&
        rwnx_hw->usbdev->pid == USB_PRODUCT_ID_MERCUSYS_MA14H) {
        filename = FW_USERCONFIG_NAME_8800DC_MA14H;
    }
