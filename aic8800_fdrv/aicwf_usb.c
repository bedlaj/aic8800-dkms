...
static int aicwf_usb_chipmatch(struct aic_usb_dev *usb_dev, u16_l vid, u16_l pid){
	...
	if(pid == USB_PRODUCT_ID_AIC8801){
		...
		|| pid == USB_PRODUCT_ID_AIC8800FC_CUS6 || pid == USB_PRODUCT_ID_MERCUSYS
		|| pid == USB_PRODUCT_ID_MERCUSYS_MA14H){
...
static struct usb_device_id aicwf_usb_id_table[] = {
    ...
    {USB_DEVICE(USB_VENDOR_ID_MERCUSYS, USB_PRODUCT_ID_MERCUSYS_MA14H)},
